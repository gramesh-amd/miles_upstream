"""OLMo 3 Megatron-to-HF weight converter.

Same QKV/MLP structure as Llama, but different layer norm names:
  - post_attention_layernorm (not input_layernorm)
  - post_feedforward_layernorm (not post_attention_layernorm in Llama's pre-norm sense)
  - q_layernorm / k_layernorm (full-dim QK norms)
"""
